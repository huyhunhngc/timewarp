package com.zero.hm.effect.timewarpscan.filter;
...
public class GLFiltererBase {
    ...
    public GLFiltererBase() {
        this(DEFAULT_VERTEX_SHADER, DEFAULT_FRAGMENT_SHADER);
    }

    public GLFiltererBase(final Resources res, final int vertexShaderSourceResId, final int fragmentShaderSourceResId) {
        this(res.getString(vertexShaderSourceResId), res.getString(fragmentShaderSourceResId));
    }

    public GLFiltererBase(final String vertexShaderSource, final String fragmentShaderSource) {
