...
public class MainActivity extends AppCompatActivity implements Listener, EasyPermissions.PermissionCallbacks {
    ...
    private void clickListeners() {
        ...
        binding.btnSlow.setOnClickListener(view -> {
            setAllInactive();
        ...
        binding.btnFast.setOnClickListener(view -> {
            setAllInactive();
        ...
        binding.btnWarpHorizontal.setOnClickListener(view -> onScan(MODE_HORIZONTAL));

        binding.btnWarpVertical.setOnClickListener(view -> onScan(MODE_VERTICAL));

        binding.btnSaveToGallery.setOnClickListener(view -> {
            Log.d("TAG", "onClick: " + hasWritePermissions());
            if (hasWritePermissions()) {
                hideAllActions();
                new Handler(getMainLooper()).postDelayed(this::startProjection, 1000);
            } else {
                requestExternalStoragePermission();
            }
        });

        binding.btnSwitch.setOnClickListener(view -> onCameraSwitch());
